...
void spin(int speed, int angle, int direction)
{
    while(direction == l)
    {
        cmpc(0);
...
void strafe(int direction, int speed, int mpc1)
{
    while (direction==r)
    {
        cmpc(1);
        while(gmpc(1)<mpc1-26)
        {
            mecwsleep(-speed,speed,-speed,speed);
        }
    }
...
void diag(int direction,int speed,int mpc2)
{
